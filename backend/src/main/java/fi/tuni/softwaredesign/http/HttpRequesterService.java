...
public final class HttpRequesterService implements HttpRequester {
     ...
     */
    public HttpRequesterService(final RestTemplate restTemplate) {
    ...
    @Override
    public <T> T post(final String url, final Object body,
    ...
    @Override
    public <T> T put(final String url, final Object body,
            final Class<T> responseType,
            final Map<String, String> headers) {
        HttpHeaders httpHeaders = createHeaders(headers);
        HttpEntity<?> entity = new HttpEntity<>(body, httpHeaders);
    ...
    @Override
    public <T> T patch(final String url, final Object body,
            final Class<T> responseType,
            final Map<String, String> headers) {
        HttpHeaders httpHeaders = createHeaders(headers);
        HttpEntity<?> entity = new HttpEntity<>(body, httpHeaders);
    ...
    /**
     * Creates HTTP headers with the given custom headers.
