...
public class BreweryRestaurantService {
    ...
    public BreweryRestaurantService(OpenBreweryDbService breweryService,
                                    YelpPlacesService yelpService) {
        this.breweryService = breweryService;
        this.yelpService = yelpService;
    }

    public List<OpenBreweryDbDistanceResponseDto> getBreweries(CoordinateDto coordinates, Integer limit) {
        return breweryService.getBreweriesByDistance(coordinates, limit);
    }

    public List<YelpBusinessDistanceResponseDto> getRestaurants(CoordinateDto coordinates, Integer limit) {
